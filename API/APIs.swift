...
open class DisneyAPIAPIConfiguration: @unchecked Sendable {
    ...
    public init(
        basePath: String = "https://api.artic.edu/api/v1",
    ...
    convenience init(type: APIType = .art) {
        self.init(basePath: type.basePath)
    }

    public static func shared(type: APIType) -> DisneyAPIAPIConfiguration {
        return DisneyAPIAPIConfiguration(type: type)
    }
}
...
open class RequestBuilder<T>: @unchecked Sendable, Identifiable {
    ...
    public let apiConfiguration: DisneyAPIAPIConfiguration

    /// Optional block to obtain a reference to the request's progress instance when available.
    public var onProgressReady: ((Progress) -> Void)?

    required public init(method: String, URLString: String, parameters: [String: any Sendable]?, headers: [String: String] = [:], requiresAuthentication: Bool, apiConfiguration: DisneyAPIAPIConfiguration) {
        self.method = method
